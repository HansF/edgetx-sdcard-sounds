...
ELEVENLABS_VOICE_JOBS: tuple[ElevenLabsVoiceJob, ...] = (
    ...
    # round four: a male voice for languages that only had a female one
    ElevenLabsVoiceJob("./voices/de-DE.csv", "FTNCalFNG5bRnkkaP5Ug", "de-otto", language="de", stt_language="deu"),
    ElevenLabsVoiceJob("./voices/fr-FR.csv", "a5n9pJUnAhX4fn7lx3uo", "fr-martin", language="fr", stt_language="fra"),
    ElevenLabsVoiceJob("./voices/it-IT.csv", "W71zT1VwIFFx3mMGH2uZ", "it-marcotrox", language="it", stt_language="ita"),
    ElevenLabsVoiceJob("./voices/it-IT_scripts.csv", "W71zT1VwIFFx3mMGH2uZ", "it-marcotrox/SCRIPTS", language="it", stt_language="ita"),
    ElevenLabsVoiceJob("./voices/cs-CZ.csv", "uYFJyGaibp4N2VwYQshk", "cz-adam", language="cs", stt_language="ces"),
    ElevenLabsVoiceJob("./voices/ru-RU.csv", "3EuKHIEZbSzrHGNmdYsx", "ru-nikolay", language="ru", stt_language="rus"),
    # funny character packs (en-fun-<slug>.csv = en-GB text with the character's event lines)
    ElevenLabsVoiceJob("./voices/en-fun-pit-crew.csv", "NoiYxL9g25M4orC8Q0ls", "en_fun-pit-crew", stability=0.4, style=0.4, speed=1.1),
    ElevenLabsVoiceJob("./voices/en-fun-pit-crew_scripts.csv", "NoiYxL9g25M4orC8Q0ls", "en_fun-pit-crew/SCRIPTS", stability=0.4, style=0.4, speed=1.1),
    ElevenLabsVoiceJob("./voices/en-fun-fighter-pilot.csv", "mtrellq69YZsNwzUSyXh", "en_fun-fighter-pilot", stability=0.35, style=0.5, speed=1.0),
    ElevenLabsVoiceJob("./voices/en-fun-fighter-pilot_scripts.csv", "mtrellq69YZsNwzUSyXh", "en_fun-fighter-pilot/SCRIPTS", stability=0.35, style=0.5, speed=1.0),
    ElevenLabsVoiceJob("./voices/en-fun-butler.csv", "JZ5PEPqtr05GbBRBqPhz", "en_fun-butler", stability=0.7, style=0.3, speed=0.95),
    ElevenLabsVoiceJob("./voices/en-fun-butler_scripts.csv", "JZ5PEPqtr05GbBRBqPhz", "en_fun-butler/SCRIPTS", stability=0.7, style=0.3, speed=0.95),
    ElevenLabsVoiceJob("./voices/en-fun-race-engineer.csv", "zCgijgIKIMkFHnzXcCva", "en_fun-race-engineer", stability=0.3, style=0.6, speed=1.15),
    ElevenLabsVoiceJob("./voices/en-fun-race-engineer_scripts.csv", "zCgijgIKIMkFHnzXcCva", "en_fun-race-engineer/SCRIPTS", stability=0.3, style=0.6, speed=1.15),
    ElevenLabsVoiceJob("./voices/en-fun-arcade.csv", "CeNX9CMwmxDxUF5Q2Inm", "en_fun-arcade", stability=0.35, style=0.6, speed=1.05),
    ElevenLabsVoiceJob("./voices/en-fun-arcade_scripts.csv", "CeNX9CMwmxDxUF5Q2Inm", "en_fun-arcade/SCRIPTS", stability=0.35, style=0.6, speed=1.05),
    ElevenLabsVoiceJob("./voices/en-fun-gloomy-mechanic.csv", "wcATjh8zBDfepqUbl99V", "en_fun-gloomy-mechanic", stability=0.6, style=0.3, speed=0.9),
    ElevenLabsVoiceJob("./voices/en-fun-gloomy-mechanic_scripts.csv", "wcATjh8zBDfepqUbl99V", "en_fun-gloomy-mechanic/SCRIPTS", stability=0.6, style=0.3, speed=0.9),
    ElevenLabsVoiceJob("./voices/en-fun-bunker-computer.csv", "ZEcx3Wdpj4EvM8PltzHY", "en_fun-bunker-computer", stability=0.85, style=0.0, speed=0.95),
    ElevenLabsVoiceJob("./voices/en-fun-bunker-computer_scripts.csv", "ZEcx3Wdpj4EvM8PltzHY", "en_fun-bunker-computer/SCRIPTS", stability=0.85, style=0.0, speed=0.95),
    ElevenLabsVoiceJob("./voices/en-fun-evil-ai.csv", "ybjoxm7ASLDUFh2pC2eM", "en_fun-evil-ai", stability=0.7, style=0.3, speed=0.92),
    ElevenLabsVoiceJob("./voices/en-fun-evil-ai_scripts.csv", "ybjoxm7ASLDUFh2pC2eM", "en_fun-evil-ai/SCRIPTS", stability=0.7, style=0.3, speed=0.92),
    ElevenLabsVoiceJob("./voices/en-fun-nature-narrator.csv", "jvcMcno3QtjOzGtfpjoI", "en_fun-nature-narrator", stability=0.65, style=0.35, speed=0.92),
    ElevenLabsVoiceJob("./voices/en-fun-nature-narrator_scripts.csv", "jvcMcno3QtjOzGtfpjoI", "en_fun-nature-narrator/SCRIPTS", stability=0.65, style=0.35, speed=0.92),
